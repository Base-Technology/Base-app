    ...
    <View style={{ ...styles.container, backgroundColor: '#1e1e1e' }}>
      <View style={{ position: 'relative' }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <View style={{ height: 60, padding: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start' }}>
            ...
            <Text style={{ fontSize: 18 }}>Create Token</Text>
          </View>
        </View>
      </View>
      <View style={{ flex: 1, padding: 10 }}>
        <View style={{ flexDirection: 'row', backgroundColor: 'rgba(0,0,0,1)', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 5, marginVertical: 10, marginBottom: 20, borderRadius: 5 }}>
          <TextInput style={{ flex: 1, padding: 0, color: '#fff' }} placeholderTextColor="#8c8c8c" placeholder={'Token Name'} />
        </View>
        <View style={{ flexDirection: 'row', backgroundColor: 'rgba(0,0,0,1)', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 5, marginVertical: 10, marginBottom: 20, borderRadius: 5 }}>
          <TextInput style={{ flex: 1, padding: 0, color: '#fff' }} placeholderTextColor="#8c8c8c" placeholder={'Token Symbol'} />
        </View>
        <View style={{ flexDirection: 'row', backgroundColor: 'rgba(0,0,0,1)', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 5, marginVertical: 10, marginBottom: 20, borderRadius: 5 }}>
          <TextInput style={{ flex: 1, padding: 0, color: '#fff' }} placeholderTextColor="#8c8c8c" placeholder={'Total Supply'} />
        </View>
