  ...
  return (
    <View style={{ height: 760 }}>
      ...
      <View style={{ marginHorizontal: 20, borderBottomColor: 'rgba(255,255,255,0.5)', borderBottomWidth: 0.5, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }} >
        ...
        {profileImg && <Image style={{ width: 100, height: 100 }} resizeMode="cover" source={{ uri: profileImg }} /> || <TextInput placeholderTextColor="#8c8c8c" color="#fff" style={{}} placeholder="Profile image" value={profileId} onChangeText={profileId => onChangProfileId(profileId)} />}
